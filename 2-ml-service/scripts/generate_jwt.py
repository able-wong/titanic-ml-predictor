...
Examples:
  ...
  Generate token for testing predictions:
    ...
    parser.add_argument(
        "--username",
        help="Optional username to include in the token"
    )
    ...
    try:
        ...
        print(f"Expires in: {args.expires_in} seconds ({args.expires_in // 60} minutes)")
        ...
        print("  -d '{\"pclass\": 1, \"sex\": \"female\", \"age\": 25, \"sibsp\": 0, \"parch\": 0, \"fare\": 100, \"embarked\": \"S\"}'")
