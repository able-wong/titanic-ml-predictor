    ...
    async def load_models(self) -> None:
        ...
        if not os.path.exists(self.models_dir):
            raise ConfigurationError(
                ...
                details={
                    "models_dir": self.models_dir,
                    "suggestion": "Run the training pipeline first",
                },
            )
        ...
        try:
            ...
            # Load trained models
            self.logger.info("Loading trained models", initialization_phase="models")
    ...
    async def predict_survival(self, passenger_data: Dict[str, Any]) -> PredictionResponse:
        ...
        try:
            ...
            return PredictionResponse(
                individual_models=individual_models, ensemble_result=ensemble_result
            )
