...
class MLService:
    ...
    async def load_models(self) -> None:
        ...
        try:
            ...
            # Load trained models
            # SECURITY NOTE: pickle.load() is used here for ML model deserialization.
            # This is safe because:
            # 1. Models are generated by our own training pipeline
            # 2. Model files are stored in a controlled environment
            # 3. No external/user-provided pickle files are loaded
