...
from app.core.exceptions import (
    ConfigurationError, PredictionError, ModelUnavailableError, 
    PredictionInputError, ModelNotLoadedError
)
            ...
            try:
                ...
                with concurrent.futures.ThreadPoolExecutor(max_workers=3) as executor:
                    ...
                    lr_future = executor.submit(
                        load_model, 
                        os.path.join(self.models_dir, 'logistic_model.pkl')
                    )
    ...
    def get_feature_columns(self) -> list:
        ...
        if self._feature_columns is None:
            self._feature_columns = [
                ...
                'fare', 'embarked', 'family_size', 'is_alone', 'age_group'
            ]
