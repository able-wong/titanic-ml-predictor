...
from app.core.exceptions import (
    MLServiceError, ValidationError, PredictionError, 
    PredictionInputError, ModelUnavailableError, ModelNotLoadedError
)
...
async def predict_survival(
    ...
    **Performance:**
    ...
    except (MLServiceError, ValidationError, PredictionError, PredictionInputError, 
            ModelUnavailableError, ModelNotLoadedError):
