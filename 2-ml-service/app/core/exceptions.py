...
class MLServiceError(Exception):
    ...
    def to_http_exception(self, request_id: str = None) -> HTTPException:
        ...
        return HTTPException(
            ...
            detail=self.to_error_detail(request_id).dict()
        )
...
class ModelNotLoadedError(MLServiceError):
    ...
    def __init__(self, model_name: str = None, **kwargs):
        message = f"ML model '{model_name}' is not loaded" if model_name else "ML models are not loaded"
...
class ExternalServiceError(MLServiceError):
    ...
    def __init__(self, message: str, service_name: str = None, service_status: int = None, **kwargs):
        details = kwargs.get('details', {})
        if service_name:
