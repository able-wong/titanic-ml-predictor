...
class ModelsConfig(BaseModel):
    ...
    preprocessor_path: str = Field(default="../models", description="Path to preprocessor artifacts")
...
class HealthConfig(BaseModel):
    ...
    include_model_accuracy: bool = Field(default=True, description="Include model accuracy in health check")
    include_feature_info: bool = Field(default=True, description="Include feature info in health check")
