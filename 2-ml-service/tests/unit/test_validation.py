...
from app.utils.validation import InputSanitizer, validate_passenger_input, validate_query_parameters
...
class TestInputSanitizer:
    ...
    def test_sanitize_string_excessive_whitespace(self, sanitizer):
        ...
        result = sanitizer.sanitize_string("test          with     spaces", "test_field")
        assert "          " not in result
        assert result == "test with     spaces"  # Regex only removes 10+ consecutive spaces
